	...
	public class AdminController : ControllerBase
	{
		...
		public IActionResult AddCourse([FromBody] Course course)
		{
			try
			{
				...
				if (course.ImageLink == null)
				{
                    course.ImageLink = "https://every-tuesday.com/wp-content/uploads/2016/04/courses.jpg";
                }
				if(course.Description == null)
				{
					course.Description = "www.google.com";
				}
		...
		public IActionResult UpdateCourse(int CourseId, [FromBody] Course CourseObj)
		{
			try
			{
				...
				if (course != null)
				{
					...
					course.ImageLink = CourseObj.ImageLink;

...
export default function Trainer(){
    ...
    const getTrainer=()=>{
      axios.get(`https://localhost:44307/api/Trainer/GetTrainerbyId`,{
        headers:{
    ...
    return(
      <NavTrainer>
        ...
        <Grid>
            ...
            <p><b>Created At :</b>  {new Date(trainer.createdAt).getFullYear()+"-"+new Date(trainer.createdAt).getMonth()+"-"+new Date(trainer.createdAt).getDate()} </p>

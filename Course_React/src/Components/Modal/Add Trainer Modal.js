...
export default function TrainerModal() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.send("service_yuwd85c","template_15v6hl8",{
  name: "username@coursepedia.com",
  password: "username@123",
  },'trWWP7UqmkkqSde1K').then((result) => {
  ...
  const AddTrainer=()=>{
    axios.post(`https://localhost:44307/api/Admin/AddTrainer`,{
       "name":name,
       "email":email,
       "contact":contact,
       "password":password,

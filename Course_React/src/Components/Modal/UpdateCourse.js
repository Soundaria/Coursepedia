...
export default function  UpdateCourse(props){
  ...
  const onClick= ()=>{
    axios.get(`https://localhost:44307/api/Course/GetCoursebyid/${props.id}`
    ).then((response)=>{
  ...
  const UpdateCourse= ()=>{
    ...
    axios.put(`https://localhost:44307/api/Admin/UpdateCourse/${props.id}`,{
        "courseName":name,
    ...
    <>
      ...
      <Center >
       ...
       <Grid justify="center" align="center">
            ...
            <br/>
            <Grid.Col span={10}>
                <TextBox type="text" label='Description'  placeholder="Enter the Description" value={desc} onChange={changeDesc}/>
            </Grid.Col>
            <br/>
            <Grid.Col span={10}>
                <TextBox type="text" label='ImageLink' placeholder="Enter the ImageLink" value={image} onChange={changeImage}/>
            </Grid.Col>
             </Grid>
            <br/>
            <Center>
